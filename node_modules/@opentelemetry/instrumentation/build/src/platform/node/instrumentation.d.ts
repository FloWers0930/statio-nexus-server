import type * as types from '@opentelemetry/instrumentation/build/src/types';
import type { massWrap, massUnwrap } from '@opentelemetry/instrumentation/build/src/shimmer';
import { wrap, unwrap } from '@opentelemetry/instrumentation/build/src/shimmer';
import { InstrumentationAbstract } from '@opentelemetry/instrumentation/build/src/instrumentation';
import type { InstrumentationConfig } from '@opentelemetry/instrumentation/build/src/types';
/**
