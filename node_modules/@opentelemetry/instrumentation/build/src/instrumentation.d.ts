...
import type { InstrumentationModuleDefinition, Instrumentation, InstrumentationConfig, SpanCustomizationHook } from '@opentelemetry/instrumentation/build/src/types';
/**
...
export declare abstract class InstrumentationAbstract<ConfigType extends InstrumentationConfig = InstrumentationConfig> implements Instrumentation<ConfigType> {
    ...
    protected _wrap: <Nodule extends object, FieldName extends keyof Nodule>(nodule: Nodule, name: FieldName, wrapper: (original: Nodule[FieldName], name: FieldName) => Nodule[FieldName]) => import("@opentelemetry/instrumentation/build/src/types").ShimWrapped | undefined;
